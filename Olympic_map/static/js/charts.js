...
//     d3.json("summer_ML.json").then((data) => {
...
//     d3.json("summer_ML.json").then((data) => {
//       var poulation = data.population;
//       // Filter the data for the object with the desired sample number
//       var resultArray = population.filter(sampleObj => sampleObj.noc == sample);
...
//       var samplesArray = data.country;
//       console.log(samplesArray, "line 63");
//       // 4. Create a variable that filters the samples for the object with the desired sample number.
//       var newSampleArray = samplesArray.filter(sampleObj => sampleObj.country == sample);
